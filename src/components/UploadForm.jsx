...
export function UploadForm() {
  ...
  return (
    <div className="bg-white dark:bg-gray-700 p-4 rounded shadow">
      ...
      <button onClick={handleOCR} disabled={!file} className="w-full py-2 bg-blue-600 text-white rounded mb-2">
      ...
      <button onClick={handleUpload} disabled={!ocrText} className="w-full py-2 bg-green-600 text-white rounded">
        Save Expense
      </button>
    </div>
  );
